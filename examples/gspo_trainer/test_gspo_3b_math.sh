...
DATA_ROOT=/home/work/DDAI_revised/verl
...
export WANDB_API_KEY="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"
...
CKPTS_DIR=${DATA_ROOT}/checkpoint/${loss_mode}/${exp_name}
...
if [ "$first_time_dataset_prep" = true ]; then
    ...
    python examples/data_preprocess/gsm8k.py --local_save_dir ${DATA_ROOT}/data/gsm8k/
fi

gsm8k_train_path=${DATA_ROOT}/data/gsm8k/train.parquet
gsm8k_test_path=${DATA_ROOT}/data/gsm8k/test.parquet
