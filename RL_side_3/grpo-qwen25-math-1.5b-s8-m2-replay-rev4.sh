...
experiment_name=grpo-qwen25-math-1.5b-s8-m2-replay-rev4
...
python3 -u -m verl.trainer.main_ppo \
    ...
    +algorithm.m2_replay.schedule.fixed_total_groups=320 \
    +algorithm.m2_replay.schedule.fixed_total_floor_groups=256 \
