...
experiment_name=grpo-qwen-math-7b-s8-m2-replay-rev1-e1l4
...
python3 -u -m verl.trainer.main_ppo \
    ...
    +algorithm.m2_replay.tau=0.02 \
    +algorithm.m2_replay.buffer.max_query_groups=1024 \
    +algorithm.m2_replay.selection.recent_learning_beta=1.0 \
    +algorithm.m2_replay.selection.recent_learning_decay_lambda=4.0 \
