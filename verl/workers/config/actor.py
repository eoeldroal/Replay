...
class ActorConfig(BaseConfig):
    ...
    # Policy diagnostics (.pt file logging for IS ratio analysis)
    policy_diag_dir: Optional[str] = None  # 저장 경로. None이면 비활성.
    policy_diag_flush_freq: int = 32  # flush 주기 (micro-batch 호출 횟수 단위)
