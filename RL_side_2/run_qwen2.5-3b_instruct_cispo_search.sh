...
export WANDB_PROJECT="${WANDB_PROJECT:-cispo_phase1_revised}"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.rollout_data_dir=./logs/cispo_search_rollout_data_${RUN_TS} \
    trainer.validation_data_dir=./logs/cispo_search_val_data_${RUN_TS} \
    trainer.project_name=cispo_phase1_revised \
    trainer.experiment_name=cispo_search_phase1_revised \
