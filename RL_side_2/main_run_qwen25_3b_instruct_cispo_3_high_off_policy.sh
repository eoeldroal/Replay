#!/usr/bin/env bash
# CISPO training with Qwen2.5-3B-Instruct on DAPO-Math-17k-Processed.
# Based on CISPO_qwen25_3b_instruct_2 with high off-policy setup.
...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.policy_diag_dir=/home/work/DDAI_revised/verl/logs/CISPO_qwen25_3b_instruct_diag_3_high_off_policy_v2 \
    ...
    trainer.experiment_name='CISPO_qwen25_3b_instruct_3_high_off_policy_v2' \
    trainer.rollout_data_dir='/home/work/DDAI_revised/verl/logs/CISPO_qwen25_3b_instruct_rollout_3_high_off_policy_v2' \
    trainer.validation_data_dir='/home/work/DDAI_revised/verl/logs/CISPO_qwen25_3b_instruct_validation_3_high_off_policy_v2' \
