# GCISPO training with Qwen2.5-3B-Instruct on DAPO-Math-17k-Processed (competition-level math)
# Based on run_qwen3-8b_4.sh (GRPO baseline), adapted for Qwen2.5-3B-Instruct + GCISPO policy loss.
...
# │ clip_ratio_low    │ 0.0003       │ 10           │ 0.0003       │ GSPO-matched     │
# │ clip_ratio_high   │ 0.0004       │ 0.2          │ 0.0004       │ GSPO-matched     │
# │ clip_ratio_c      │ 10.0         │ --           │ --           │ GSPO only        │
# │ use_kl_loss       │ False        │ True         │ False        │ KL removed       │
# │ kl_loss_coef      │ 0.0          │ 0.001        │ 0.0          │ KL removed       │
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.clip_ratio_low=0.005 \
    actor_rollout_ref.actor.clip_ratio_high=0.005 \
    +actor_rollout_ref.actor.policy_diag_dir=/home/work/DDAI_revised/verl/logs/GCISPO_qwen25_3b_instruct_diag_3_clip_0.005 \
    ...
    trainer.experiment_name='GCISPO_qwen25_3b_instruct_3_clip_0.005' \
    trainer.rollout_data_dir='/home/work/DDAI_revised/verl/logs/GCISPO_qwen25_3b_instruct_rollout_3_clip_0.005' \
    trainer.validation_data_dir='/home/work/DDAI_revised/verl/logs/GCISPO_qwen25_3b_instruct_validation_3_clip_0.005' \
