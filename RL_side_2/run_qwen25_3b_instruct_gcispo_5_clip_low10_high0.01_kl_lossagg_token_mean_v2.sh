#!/usr/bin/env bash
# GCISPO(+KL) training with Qwen2.5-3B-Instruct on DAPO-Math-17k-Processed.
#
# Derived from:
#   RL_side_2/run_qwen25_3b_instruct_gcispo_4_clip_0.005.sh (original baseline)
#
# Changes vs GCISPO_4:
# - Add KL loss like CISPO:
#     actor_rollout_ref.actor.use_kl_loss=True
#     actor_rollout_ref.actor.kl_loss_coef=0.001
#     actor_rollout_ref.actor.kl_loss_type=low_var_kl
# - Change policy loss aggregation:
#     actor_rollout_ref.actor.loss_agg_mode=token-mean
# - Disable lower clipping in policy ratio:
#     actor_rollout_ref.actor.clip_ratio_low=10
#   while keeping upper clip:
#     actor_rollout_ref.actor.clip_ratio_high=0.01
#
# Reward config stays identical to GCISPO_4:
# - answer_score_cfg.mode=one_or_zero (effective answer reward is 0/1)
# - overlong_buffer_cfg.mode=binary + binary_combine_mode=plus_one_or_zero (length/overlong stays 0/1-style)
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.clip_ratio_low=10 \
    actor_rollout_ref.actor.clip_ratio_high=0.01 \
    +actor_rollout_ref.actor.policy_diag_dir=/home/work/DDAI_revised/verl/logs/GCISPO_qwen25_3b_instruct_diag_5_clip_low10_high0.01_kl_lossagg_token_mean_v2 \
    ...
    trainer.experiment_name='GCISPO_qwen25_3b_instruct_5_clip_low10_high0.01_kl_lossagg_token_mean_v2' \
    trainer.rollout_data_dir='/home/work/DDAI_revised/verl/logs/GCISPO_qwen25_3b_instruct_rollout_5_clip_low10_high0.01_kl_lossagg_token_mean_v2' \
    trainer.validation_data_dir='/home/work/DDAI_revised/verl/logs/GCISPO_qwen25_3b_instruct_validation_5_clip_low10_high0.01_kl_lossagg_token_mean_v2' \
