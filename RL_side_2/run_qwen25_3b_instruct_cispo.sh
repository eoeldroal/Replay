...
#   - use_kl_loss: False -> True (CISPO needs KL regularization)
#   - kl_loss_coef: 0.001 (CISPO default)
#   - kl_loss_type: low_var_kl (CISPO default)
#
...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.policy_diag_dir=/home/work/DDAI_revised/verl/logs/CISPO_qwen25_3b_instruct_diag_3_clip_0.005 \
    ...
    trainer.experiment_name='CISPO_qwen25_3b_instruct_3_clip_0.005' \
    trainer.rollout_data_dir='/home/work/DDAI_revised/verl/logs/CISPO_qwen25_3b_instruct_rollout_3_clip_0.005' \
    trainer.validation_data_dir='/home/work/DDAI_revised/verl/logs/CISPO_qwen25_3b_instruct_validation_3_clip_0.005' \
