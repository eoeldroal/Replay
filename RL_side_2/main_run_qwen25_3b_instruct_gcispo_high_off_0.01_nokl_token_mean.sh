...
#   loss_mode=gcispo, clip_ratio_low=10, clip_ratio_high=0.01
#   loss_agg_mode=token-mean
#
# Differences vs CISPO baseline:
#   - loss_mode: gcispo (vs cispo)
#   - clip_ratio_high: 0.01 (vs 0.2)
...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.policy_diag_dir=/home/work/DDAI_revised/verl/logs/GCISPO_qwen25_3b_instruct_diag_6_high_off_0.01_nokl_token_mean \
    ...
    trainer.experiment_name='GCISPO_qwen25_3b_instruct_6_high_off_0.01_nokl_token_mean' \
    trainer.rollout_data_dir='/home/work/DDAI_revised/verl/logs/GCISPO_qwen25_3b_instruct_rollout_6_high_off_0.01_nokl_token_mean' \
    trainer.validation_data_dir='/home/work/DDAI_revised/verl/logs/GCISPO_qwen25_3b_instruct_validation_6_high_off_0.01_nokl_token_mean' \
